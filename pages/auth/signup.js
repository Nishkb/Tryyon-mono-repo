...
import DefaultAuth from '../../ui/layouts/auth/Default';
...
function Signup() {
    ...
    return (
        <DefaultAuth heading="Sign up">
            <Flex mx="auto" flexDirection="column" pb="70px">
                <Box me="auto">
                    ...
                    <Formik
                        ...
                        onSubmit={(values) => {
                            ...
                            fetch('/api/user/register', {
                                ...
                                body: JSON.stringify(rest, null, 6)
                            })
                                .then((res) => res.json())
                                .then((res) => {
