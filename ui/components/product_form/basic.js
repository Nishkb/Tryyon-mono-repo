    ...
    <Formik
      ...
      onSubmit={(values) => {
        if (supplier == '') {
          ...
          onSubmit({ ...values, supplierId: supplier, locationIds: locations });
      }}
    >
          ...
          <Flex direction="column" gap="16px">
            <Flex h="max-content" direction="column">
              ...
              >
                ...
                />
                <FormErrorMessage>{errors.shortDescriptions}</FormErrorMessage>
                {/* </InputGroup> */}
              </FormControl>
              ...
              <FormControl mb="4px" isInvalid={!!errors.price && touched.price}>
                <FormLabel
                  display="flex"
                  ms="4px"
                  fontSize="sm"
              ...
              <FormControl
                mb="4px"
                isInvalid={!!errors.discountedPrice && touched.discountedPrice}
              >
                <FormLabel
                  display="flex"
                  ms="4px"
              ...
              <FormControl
                mb="4px"
                isInvalid={!!errors.countryOfOrigin && touched.countryOfOrigin}
              >
                <FormLabel
                  ms="4px"
                  fontSize="sm"
              ...
              <FileInput
                ...
                accept="image/*"
                colorScheme="blue"
                urlList={values.featureImage ? [values.featureImage] : []}
                onChange={(e) => {
                  if (e.target.files[0].size > 2097152) {
                    ...
                    fetch('/api/upload/', {
                      ...
                      .then((res) => {
                        ...
                        setValues((prev) => ({
                          ...prev,
                          featureImage: res.body.location
                        }));
                      })
                      .catch((err) => {
                        toast({
              ...
              <FileInput
                ...
                onChange={(e) => {
                  ...
                  if (!flag) {
                    const imageData = new FormData();
                    for (let i = 0; i < e.target.files.length; i++) {
                      imageData.append('images', e.target.files[i]);
                    }
                    ...
                    fetch('/api/upload/bulk', {
                      ...
                      .then((res) => {
                        ...
                        setValues((prev) => ({
                          ...prev,
                          gallery: res.body.map((img) => img.location)
                        }));
                      })
                      .catch((err) => {
                        toast({
              ...
              <Flex>
                <RadioGroup onChange={(value) => setLocations([value])}>
