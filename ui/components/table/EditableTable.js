                ...
                return (
                  <Tr key={index}>
                    {Object.keys(row).map((_, idx) => {
                      ...
                      if (columnsData[idx].type == 'editable') {
                        return (
                          <Td key={idx} w="200px" minW="200px">
                            <Editable
                              value={row[columnsData[idx].accessor]}
                              onChange={(value) => {
                                setTableData((prev) => {
                                  const newArr = [...prev];
                                  newArr[index][columnsData[idx].accessor] =
                                    parseInt(value, 10).toString() !== 'NaN'
                                      ? parseInt(value, 10)
                                      : 0;
                                  return newArr;
                                });
